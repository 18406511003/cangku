...
<form id="item_in" name="item_in" method="post" action="receipt_in_bg.php" onsubmit=" return checkForm()">
  ...
  <p><a href="/warehouse-1.13/basic/company/company_show.php" target="_self"><img src="/warehouse-1.13/image/delete.gif" alt="往来公司管理" width="25" height="19" border="0"/></a></p>
  <label>录单日期</label>
  ...
  <p><a href="/warehouse-1.13/basic/warehouse/warehouse_show.php" target="_self"><img src="/warehouse-1.13/image/delete.gif" alt="仓库管理" width="25" height="19" border="0"/></a></p>
  <label>业务员</label>
  ...
  <p><a href="../test/_self" target="_self"><img src="/warehouse-1.13/image/delete.gif" alt="出入库类型管理" width="25" height="19" border="0"/></a></p>
  </fieldset>
